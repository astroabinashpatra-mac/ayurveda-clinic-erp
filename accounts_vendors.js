  ...
  container.innerHTML = `
    ...
    <div id="modal-register-vendor" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.85); align-items: center; justify-content: center; z-index: 999999; padding: 1rem;">
      <div style="background: #1e293b; width: 520px; max-width: 95vw; padding: 1.5rem; border-radius: 8px; border: 1px solid #334155; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.5);">
        ...
        <div style="margin-bottom: 1rem;">
          <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">Company / Vendor Name *</label>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
          ...
          <div>
            <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">GST No.</label>
        ...
        <div style="margin-bottom: 1.5rem;">
          <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">Address</label>
    ...
    <div id="modal-record-ledger" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.85); align-items: center; justify-content: center; z-index: 999999; padding: 1rem;">
      <div style="background: #1e293b; width: 500px; max-width: 95vw; padding: 1.5rem; border-radius: 8px; border: 1px solid #334155; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.5);">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
          <div>
            <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">DATE *</label>
          ...
          <div>
            <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">TYPE *</label>
        ...
        <div style="margin-bottom: 1rem;">
          <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">PARTICULARS / CATEGORY *</label>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
          ...
          <div>
            <label style="color: #9ca3af; font-size: 0.8rem; display: block; margin-bottom: 0.3rem;">PAYMENT MODE</label>
